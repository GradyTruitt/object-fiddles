...
console.log(alert(JSON.stringify(backPack)));
...
// to make a Credit Card object and returns that object so that whenever you invoke makeCard, you get a brand new credit card.
